...
import com.postgres.springboot.repositories.MsgDataRepository;
...
public class MsgDataController {
	...
	public ModelAndView msg(ModelAndView mav) {
		...
		List<MyData> mydatalist = (List<MyData>)mydatadao.getAll();
	...
	public void init() {
		...
		mydatadao = new MyDataDaoImpl(entityManager);
	}
